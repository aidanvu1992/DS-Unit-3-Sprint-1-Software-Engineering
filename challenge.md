...
In my opinion, I always pay attention to code indentation as well as spelling. I would appreciate if the others do the same when reviewing my codes

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

Containers can help us simplify the operation by aiding the platform independence. It also can help to improve developer productivity and differentiate data processing techniques
